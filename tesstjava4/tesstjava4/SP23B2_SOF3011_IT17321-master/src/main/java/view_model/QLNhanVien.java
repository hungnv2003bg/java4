...
public class QLNhanVien {
    ...
    public QLNhanVien(String ma, String ho, String ten_dem, String ten, boolean gioi_tinh, String ngay_sinh, String sdt, String dia_chi, String mat_khau, String quoc_gia) {
        this.ma = ma;
        this.ho = ho;
